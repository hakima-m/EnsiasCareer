...
<%  String var;
    List<Ensiaste> list = EnsiasteDB.getAllEnsiaste1();
    List<Ensiaste> list1=new ArrayList<Ensiaste>();
    List<Ensiaste> list2=new ArrayList<Ensiaste>();
    for (Ensiaste en : list )
                                {
    ...
    request.setAttribute("STUDENT_LIST", list2);
    request.setAttribute("STUDENT1_LIST", list1);
...
<html>
    <head>
        ...
        <title>EnsiasCareer | Students management</title>
...
<button type="submit" class="btn btn-primary">Submit</button>
                        ...
                        <h3 class="center" style="font-family: 'Poppins', sans-serif; font-size: 45px;">Students List</h3>
<table class="table">
                            <thead class="bg-light">
<tr>
                                    <th scope="col" name="nom">Last Name</th>
                                    <th scope="col" name="prenom">First Name</th>
                                    <th scope="col" name="CNE">CNE</th>
                                    <th scope="col" name="ville">City</th>
                                    <th scope="col" name="filiere">Branch</th>
                                    <th scope="col" name="annee">Academic year</th>
                                    
                                    <th scope="col">Options</th>
                                </tr>
</thead>
                            <tbody>
                                <c:forEach var="tS" items="${STUDENT1_LIST}">
<tr class="table-danger">
                                        ...
                                        <td>${tS.annee}</td>
                                        <td> 
                                            <a href="DeleteStudentServlet?id=${tS.id}">Delete</a>
                                            <a href="ValidateStudentServlet?id=${tS.id}">Validate</a></td>
                                    </tr>
</c:forEach>
                                <c:forEach var="tS" items="${STUDENT_LIST}">
<tr>
                                        <td>${tS.nom }</td>
                                        <td>${tS.prenom }</td>
                                        <td>${tS.CNE }</td>
                                        ...
                                        <td>${tS.annee}</td>
                                        <td>
                                            <a href="DeleteStudentServlet?id=${tS.id}">Delete</a></td>
                                    </tr>
</c:forEach>
                            </tbody>
                        </table>
