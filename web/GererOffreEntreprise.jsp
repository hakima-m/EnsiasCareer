...
<%  int id = Integer.parseInt(value);
    List<Offre> list = OffreDB.getAllOffreEntreprise(id);
    request.setAttribute("OFFRE_LIST", list);
...
<html>
    <head>
        ...
        <title>EnsiasCareer | Internship Offers Management</title>
...
</div>-->               <input type="hidden" name="id_recruteur" value="<%=(String) session.getAttribute("id_entreprise")%>"/>
...
<tr>
                                    ...
                                    <th scope="col" name="contact">Contact</th>
...
<tr>
                                        ...
                                        <td>${tS.categorie}</td>
                                        <td>${tS.ville}</td>
                                        <td><a href="ModifierOffre.jsp?id=${tS.id }">Edit</a> 
                                            <a href="SupprimerOffreEntrepriseServlet?id=${tS.id}">Delete</a></td>
                                    </tr>
</c:forEach>
                            </tbody>
                        </table>
