 ...
 * @author acer
 */
public class ValidateOffreServlet extends HttpServlet {
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean test = OffreDB.validate(en);
            ...
            */
            if(test){
                request.getRequestDispatcher("adminEspaceOffre.jsp").include(request, response);
