 ...
 * @author acer
 */
public class SupprimerCommentServlet extends HttpServlet {
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           /* 
            ...
            String idO=(String)request.getParameter("id1");
            int bid = Integer.parseInt(request.getParameter("id"));
            int bid1 = Integer.parseInt(request.getParameter("id1"));              
            CommentaireDB.deleteCommentaire(bid1,bid);
            RatingDB.deleteRating(bid1,bid);
            response.sendRedirect("afficherMore.jsp?id_ensiaste="+idE+"&id_offre="+idO);
            out.println("</body>");
            out.println("</html>");
        }
    }
